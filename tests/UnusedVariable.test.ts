...
describe("UnusedVariable Rule", () => {
  const example_uri = path.join(__dirname, "../assets/example-flows/force-app/main/default/flows/Unused_Variable.flow-meta.xml");
  const fixed_uri = path.join(__dirname, "../assets/example-flows/force-app/main/default/flows/Unused_Variable_Fixed.flow-meta.xml");
