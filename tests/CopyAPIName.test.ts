...
describe("CopyAPIName ", () => {
  const example_uri = path.join(__dirname, "../assets/example-flows/force-app/main/default/flows/Copy_API_Name.flow-meta.xml");
  const fixed_uri = path.join(__dirname, "../assets/example-flows/force-app/main/default/flows/Copy_API_Name_Fixed.flow-meta.xml");
